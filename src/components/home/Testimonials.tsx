...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      quote:
        "Buildora Engineers exceeded all our expectations! Their attention to detail and commitment to quality is unmatched. The project was completed on time and within budget.",
      name: "Sarah Johnson",
    ...
    {
      quote:
        "Working with Buildora Engineers was a game-changer for our company. Their innovative approach and professional team delivered exceptional results that transformed our office space.",
      name: "Michael Chen",
