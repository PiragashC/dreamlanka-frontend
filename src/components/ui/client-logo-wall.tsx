...
const CLIENT_BADGES: ClientBadge[] = [
  ...
  {
    name: "Autodesk",
    tagline: "Construction Software",
    initials: "ADS",
    gradient: "from-accent/90 via-blue-700/75 to-blue-500/60",
  },
  {
    name: "Trimble",
    tagline: "Construction Tech",
    initials: "TRI",
  ...
  {
    name: "Knauf",
    tagline: "Drywall Systems",
    initials: "KNA",
    gradient: "from-accent/88 via-blue-600/72 to-sky-400/60",
  },
  {
    name: "Kingspan",
    tagline: "Insulation Solutions",
    initials: "KIN",
    gradient: "from-accent/88 via-blue-600/72 to-sky-400/60",
  },
  {
    name: "Schindler",
    tagline: "Elevators & Escalators",
    initials: "SCH",
    gradient: "from-accent/90 via-blue-700/75 to-blue-500/60",
  },
];
