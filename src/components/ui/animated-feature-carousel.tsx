...
const steps: readonly Step[] = [
  {
    ...
    description:
      "From surveys to approvals, we handle site analysis, planning, and local authority permits to start right.",
  },
  {
    id: "2",
    name: "Step 2",
    ...
    description:
      "Engineering-led designs with precise BOQs and schedules to ensure durability, safety, and cost control.",
  },
  {
    id: "3",
    name: "Step 3",
    title: "Quality Construction & Safety",
    description:
      "Experienced crews, strict QA/QC, and safety-first execution using modern methods and best practices.",
  },
  {
    id: "4",
    name: "Step 4",
    ...
    description:
      "Detailed commissioning, documentation, and post-handover support for long-term performance and value.",
  },
];
  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden rounded-3xl border border-border bg-card transition-colors duration-300">
        <div className="m-6 md:m-10 min-h-[420px] md:min-h-[450px] w-full">
